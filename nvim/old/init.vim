...
call plug#begin()
"call plug#begin('~/.vim/plugged'):wq
...
" Global Sets """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
syntax off           " Enable syntax highlight
...
" Desta forma, ao rodar a sequência tp, o arquivo que o cursor está no momento
" será executado.
...
" ALE """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Linters locate the warnings / fails
" flake8 general syntx
" pyright python
...
" black fixer correct after save the code
"
let g:ale_fixers = {
\   '*': ['trim_whitespace'],
\   'python':['black','isort']
